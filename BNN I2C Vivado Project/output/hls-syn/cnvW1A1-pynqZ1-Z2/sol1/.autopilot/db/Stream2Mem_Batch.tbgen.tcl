...
set C_modelArgList {
	...
	{ numReps_c129 int 32 regular {fifo 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "memOutStrm_V_V", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "numReps_c129", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ numReps_c129_dout sc_in sc_lv 32 signal 3 } 
	{ numReps_c129_empty_n sc_in sc_logic 1 signal 3 } 
	{ numReps_c129_read sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "numReps_c129_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "numReps_c129", "role": "dout" }} , 
 	{ "name": "numReps_c129_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "numReps_c129", "role": "empty_n" }} , 
 	{ "name": "numReps_c129_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "numReps_c129", "role": "read" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			{"Name" : "memOutStrm_V_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Stream2Mem_fu_56", "Port" : "in_V_V"},
					{"ID" : "2", "SubInstance" : "grp_Stream2Mem_1_fu_66", "Port" : "in_V_V"}]},
			{"Name" : "in_V", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Stream2Mem_fu_56", "Port" : "out_V"},
					{"ID" : "2", "SubInstance" : "grp_Stream2Mem_1_fu_66", "Port" : "out_V"}]},
			{"Name" : "out_V_offset", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "out_V_offset_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "numReps_c129", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "numReps_c129_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Stream2Mem_fu_56", "Parent" : "0",
		"CDFG" : "Stream2Mem",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Stream2Mem_1_fu_66", "Parent" : "0",
		"CDFG" : "Stream2Mem_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
...
set Spec2ImplPortList { 
	...
	numReps_c129 { ap_fifo {  { numReps_c129_dout fifo_data 0 32 }  { numReps_c129_empty_n fifo_status 0 1 }  { numReps_c129_read fifo_update 1 1 } } }
}
set moduleName Stream2Mem_Batch
set isTaskLevelControl 1
set isCombinational 0
