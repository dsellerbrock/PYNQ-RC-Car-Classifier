...
set C_modelArgList {
	...
	{ in_V_offset int 61 regular {fifo 0}  }
	{ inter0_V_V int 64 regular {fifo 1 volatile }  }
	{ numReps_c int 32 regular {fifo 0}  }
	{ numReps_c99 int 32 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_V", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "in_V_offset", "interface" : "fifo", "bitwidth" : 61, "direction" : "READONLY"} , 
 	{ "Name" : "inter0_V_V", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "numReps_c", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "numReps_c99", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ in_V_offset_dout sc_in sc_lv 61 signal 1 } 
	{ in_V_offset_empty_n sc_in sc_logic 1 signal 1 } 
	{ in_V_offset_read sc_out sc_logic 1 signal 1 } 
	...
	{ numReps_c_dout sc_in sc_lv 32 signal 3 } 
	{ numReps_c_empty_n sc_in sc_logic 1 signal 3 } 
	{ numReps_c_read sc_out sc_logic 1 signal 3 } 
	{ numReps_c99_din sc_out sc_lv 32 signal 4 } 
	{ numReps_c99_full_n sc_in sc_logic 1 signal 4 } 
	{ numReps_c99_write sc_out sc_logic 1 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_V_offset_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":61, "type": "signal", "bundle":{"name": "in_V_offset", "role": "dout" }} , 
 	{ "name": "in_V_offset_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_V_offset", "role": "empty_n" }} , 
 	{ "name": "in_V_offset_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_V_offset", "role": "read" }} , 
 	...
 	{ "name": "numReps_c_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "numReps_c", "role": "dout" }} , 
 	{ "name": "numReps_c_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "numReps_c", "role": "empty_n" }} , 
 	{ "name": "numReps_c_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "numReps_c", "role": "read" }} , 
 	{ "name": "numReps_c99_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "numReps_c99", "role": "din" }} , 
 	{ "name": "numReps_c99_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "numReps_c99", "role": "full_n" }} , 
 	{ "name": "numReps_c99_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "numReps_c99", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			{"Name" : "in_V", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_Mem2Stream_1_fu_82", "Port" : "in_V"},
					{"ID" : "1", "SubInstance" : "grp_Mem2Stream_fu_72", "Port" : "in_V"}]},
			{"Name" : "in_V_offset", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "in_V_offset_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "inter0_V_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_Mem2Stream_1_fu_82", "Port" : "out_V_V"},
					{"ID" : "1", "SubInstance" : "grp_Mem2Stream_fu_72", "Port" : "out_V_V"}]},
			{"Name" : "numReps_c", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "numReps_c_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "numReps_c99", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "numReps_c99_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Mem2Stream_fu_72", "Parent" : "0",
		"CDFG" : "Mem2Stream",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Mem2Stream_1_fu_82", "Parent" : "0",
		"CDFG" : "Mem2Stream_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
...
set Spec2ImplPortList { 
	...
	in_V_offset { ap_fifo {  { in_V_offset_dout fifo_data 0 61 }  { in_V_offset_empty_n fifo_status 0 1 }  { in_V_offset_read fifo_update 1 1 } } }
	inter0_V_V { ap_fifo {  { inter0_V_V_din fifo_data 1 64 }  { inter0_V_V_full_n fifo_status 0 1 }  { inter0_V_V_write fifo_update 1 1 } } }
	numReps_c { ap_fifo {  { numReps_c_dout fifo_data 0 32 }  { numReps_c_empty_n fifo_status 0 1 }  { numReps_c_read fifo_update 1 1 } } }
	numReps_c99 { ap_fifo {  { numReps_c99_din fifo_data 1 32 }  { numReps_c99_full_n fifo_status 0 1 }  { numReps_c99_write fifo_update 1 1 } } }
}
set moduleName Mem2Stream_Batch
set isTaskLevelControl 1
set isCombinational 0
