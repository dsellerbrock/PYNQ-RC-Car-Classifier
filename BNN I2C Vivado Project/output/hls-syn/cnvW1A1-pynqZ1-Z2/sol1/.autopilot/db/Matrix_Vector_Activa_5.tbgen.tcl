set moduleName Matrix_Vector_Activa_5
...
set C_modelName {Matrix_Vector_Activa.5}
...
set C_modelArgList {
	...
	{ weights6_m_weights_V int 4 regular {array 32768 { 1 3 } 1 1 } {global 0}  }
	{ threshs6_m_threshold int 16 regular {array 512 { 1 3 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_V_V", "interface" : "fifo", "bitwidth" : 4, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "weights6_m_weights_V", "interface" : "memory", "bitwidth" : 4, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "threshs6_m_threshold", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ weights6_m_weights_V_address0 sc_out sc_lv 15 signal 4 } 
	{ weights6_m_weights_V_ce0 sc_out sc_logic 1 signal 4 } 
	{ weights6_m_weights_V_q0 sc_in sc_lv 4 signal 4 } 
	{ threshs6_m_threshold_address0 sc_out sc_lv 9 signal 5 } 
	{ threshs6_m_threshold_ce0 sc_out sc_logic 1 signal 5 } 
	{ threshs6_m_threshold_q0 sc_in sc_lv 16 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "weights6_m_weights_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "weights6_m_weights_V", "role": "q0" }} , 
 	...
 	{ "name": "threshs6_m_threshold_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "threshs6_m_threshold", "role": "q0" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.BlackBoxJam_mux_6OgC_U361", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	weights6_m_weights_V { ap_memory {  { weights6_m_weights_V_address0 mem_address 1 15 }  { weights6_m_weights_V_ce0 mem_ce 1 1 }  { weights6_m_weights_V_q0 mem_dout 0 4 } } }
	threshs6_m_threshold { ap_memory {  { threshs6_m_threshold_address0 mem_address 1 9 }  { threshs6_m_threshold_ce0 mem_ce 1 1 }  { threshs6_m_threshold_q0 mem_dout 0 16 } } }
}
set moduleName Matrix_Vector_Activa_5
set isTaskLevelControl 1
set isCombinational 0
