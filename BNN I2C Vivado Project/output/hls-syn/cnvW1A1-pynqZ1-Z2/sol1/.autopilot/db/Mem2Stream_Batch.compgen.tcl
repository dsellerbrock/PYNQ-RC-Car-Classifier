...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_V_offset_dout { I 61 vector } in_V_offset_empty_n { I 1 bit } in_V_offset_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { numReps_c_dout { I 32 vector } numReps_c_empty_n { I 1 bit } numReps_c_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_numReps_c99 \
    op interface \
    ports { numReps_c99_din { O 32 vector } numReps_c99_full_n { I 1 bit } numReps_c99_write { O 1 bit } } \
} "
}
