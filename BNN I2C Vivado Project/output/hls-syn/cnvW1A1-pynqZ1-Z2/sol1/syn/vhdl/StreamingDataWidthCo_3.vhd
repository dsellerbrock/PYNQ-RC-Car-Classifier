...
architecture behav of StreamingDataWidthCo_3 is 
    ...
    signal p_4_i_reg_75 : STD_LOGIC_VECTOR (62 downto 0);
    ...
    signal p_4_cast_i_fu_161_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    p_4_i_reg_75_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_reg_186_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                p_4_i_reg_75 <= ap_phi_mux_p_Val2_s_phi_fu_112_p4(63 downto 1);
            elsif ((not(((ap_start = ap_const_logic_0) or (numReps_out_full_n = ap_const_logic_0) or (numReps_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_start = ap_const_logic_0) or (numReps_out_full_n = ap_const_logic_0) or (numReps_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    tmp_reg_181(31 downto 9) <= tmp_fu_118_p2(31 downto 9);
            end if;
        end if;
    end process;
    tmp_reg_181(8 downto 0) <= "000000000";
    ...
    ap_phi_mux_p_Val2_s_phi_fu_112_p4_assign_proc : process(ap_block_pp0_stage0, ap_enable_reg_pp0_iter2, exitcond_i_reg_186_pp0_iter1_reg, tmp_i_reg_195_pp0_iter1_reg, ap_phi_reg_pp0_iter2_p_Val2_s_reg_109, p_4_cast_i_fu_161_p1)
    begin
        if (((exitcond_i_reg_186_pp0_iter1_reg = ap_const_lv1_0) and (tmp_i_reg_195_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            ap_phi_mux_p_Val2_s_phi_fu_112_p4 <= p_4_cast_i_fu_161_p1;
        else 
    ...
    out_V_V_din <= ap_phi_mux_p_Val2_s_phi_fu_112_p4(1 - 1 downto 0);
    ...
    p_4_cast_i_fu_161_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_4_i_reg_75),64));
    p_i_fu_153_p3 <= 
        ap_const_lv32_0 when (tmp_8_i_fu_147_p2(0) = '1') else 
        o_fu_141_p2;
    t_fu_129_p2 <= std_logic_vector(unsigned(t_i_reg_98) + unsigned(ap_const_lv32_1));
    tmp_8_i_fu_147_p2 <= "1" when (o_fu_141_p2 = ap_const_lv32_40) else "0";
    tmp_fu_118_p2 <= std_logic_vector(shift_left(unsigned(numReps_dout),to_integer(unsigned('0' & ap_const_lv32_9(31-1 downto 0)))));
