...
entity DoCompute_Block_pro_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of DoCompute_Block_pro_3 is 
    ...
    signal tmp_i_reg_45 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state6 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state6 : signal is "none";
    signal grp_fu_35_p1 : STD_LOGIC_VECTOR (10 downto 0);
...
begin
    BlackBoxJam_mul_3g8j_U102 : component BlackBoxJam_mul_3g8j
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((tmp_out_out_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state7))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, numReps_empty_n, tmp_out_out_full_n, ap_CS_fsm_state7)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state7 => 
                if (((tmp_out_out_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state7))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state7;
                end if;
    ...
    ap_done_assign_proc : process(ap_done_reg, tmp_out_out_full_n, ap_CS_fsm_state7)
    begin
        if (((tmp_out_out_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state7))) then 
    ...
    ap_ready_assign_proc : process(tmp_out_out_full_n, ap_CS_fsm_state7)
    begin
        if (((tmp_out_out_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state7))) then 
    ...
    grp_fu_35_p1 <= ap_const_lv32_310(11 - 1 downto 0);
    ...
    tmp_out_out_blk_n_assign_proc : process(tmp_out_out_full_n, ap_CS_fsm_state7)
    begin
    ...
    tmp_out_out_din <= tmp_i_reg_45;

    tmp_out_out_write_assign_proc : process(tmp_out_out_full_n, ap_CS_fsm_state7)
    begin
        if (((tmp_out_out_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state7))) then 
