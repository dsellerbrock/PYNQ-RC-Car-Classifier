...
StreamingDataWidthCo_10::StreamingDataWidthCo_10(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sc_trace(mVcdFile, i_9_fu_52, "i_9_fu_52");
...
void StreamingDataWidthCo_10::thread_exitcond_i_fu_117_p2() {
    exitcond_i_fu_117_p2 = (!t_i_reg_95.read().is_01() || !tmp_reg_182.read().is_01())? sc_lv<1>(): sc_lv<1>(t_i_reg_95.read() == tmp_reg_182.read());
}

void StreamingDataWidthCo_10::thread_i_fu_131_p2() {
    i_fu_131_p2 = (!i_9_fu_52.read().is_01() || !ap_const_lv32_1.is_01())? sc_lv<32>(): (sc_biguint<32>(i_9_fu_52.read()) + sc_biguint<32>(ap_const_lv32_1));
}
...
void StreamingDataWidthCo_10::thread_phitmp_cast_i_fu_167_p3() {
    phitmp_cast_i_fu_167_p3 = esl_concat<1,62>(in_V_V_dout.read(), tmp_s_fu_157_p4.read());
}
...
void StreamingDataWidthCo_10::thread_t_fu_122_p2() {
