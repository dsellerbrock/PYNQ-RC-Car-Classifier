...
#ifndef __BlackBoxJam_mul_3ocq__HH__
#define __BlackBoxJam_mul_3ocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(BlackBoxJam_mul_3ocq) {
    ...
    SC_CTOR(BlackBoxJam_mul_3ocq):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
