...
#ifndef __BlackBoxJam_mul_3CeG__HH__
#define __BlackBoxJam_mul_3CeG__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(BlackBoxJam_mul_3CeG) {
    ...
    SC_CTOR(BlackBoxJam_mul_3CeG):  ACMP_mul_su_U ("ACMP_mul_su_U") {
