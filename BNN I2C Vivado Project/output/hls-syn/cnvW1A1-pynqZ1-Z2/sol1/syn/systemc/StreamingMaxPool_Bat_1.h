...
struct StreamingMaxPool_Bat_1 : public sc_module {
    ...
    sc_signal< sc_logic > grp_StreamingMaxPool_1_fu_53_ap_start;
    sc_signal< sc_logic > grp_StreamingMaxPool_1_fu_53_ap_done;
    sc_signal< sc_logic > grp_StreamingMaxPool_1_fu_53_ap_idle;
    sc_signal< sc_logic > grp_StreamingMaxPool_1_fu_53_ap_ready;
    sc_signal< sc_logic > grp_StreamingMaxPool_1_fu_53_in_V_V_read;
    sc_signal< sc_lv<128> > grp_StreamingMaxPool_1_fu_53_out_V_V_din;
    sc_signal< sc_logic > grp_StreamingMaxPool_1_fu_53_out_V_V_write;
    sc_signal< sc_lv<32> > rep_i_reg_42;
    sc_signal< sc_logic > ap_CS_fsm_state3;
    sc_signal< sc_logic > grp_StreamingMaxPool_1_fu_53_ap_start_reg;
    ...
    void thread_grp_StreamingMaxPool_1_fu_53_ap_start();
