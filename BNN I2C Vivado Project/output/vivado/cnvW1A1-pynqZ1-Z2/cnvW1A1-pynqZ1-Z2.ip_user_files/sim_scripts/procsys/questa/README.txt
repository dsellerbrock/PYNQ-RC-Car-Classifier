...
#
# Generated by export_simulation on Thu Apr 13 16:25:17 -0500 2023
#
################################################################################
...
'-reset_run' switch to the './procsys.sh' script.

./procsys.sh -reset_run
...
./procsys.sh -noclean_files

For more information on the script, please type './procsys.sh -help'.
