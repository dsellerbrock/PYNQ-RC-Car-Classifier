...
wire   [63:0] p_4_cast_i_fu_161_p1;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_reg_186_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        p_4_i_reg_75 <= {{ap_phi_mux_p_Val2_s_phi_fu_112_p4[63:1]}};
    end else if ((~((ap_start == 1'b0) | (numReps_out_full_n == 1'b0) | (numReps_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        p_4_i_reg_75 <= 63'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (numReps_out_full_n == 1'b0) | (numReps_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        tmp_reg_181[31 : 9] <= tmp_fu_118_p2[31 : 9];
    end
end
...
assign out_V_V_din = ap_phi_mux_p_Val2_s_phi_fu_112_p4[0:0];

assign p_4_cast_i_fu_161_p1 = p_4_i_reg_75;

assign p_i_fu_153_p3 = ((tmp_8_i_fu_147_p2[0:0] === 1'b1) ? 32'd0 : o_fu_141_p2);

assign t_fu_129_p2 = (t_i_reg_98 + 32'd1);

assign tmp_8_i_fu_147_p2 = ((o_fu_141_p2 == 32'd64) ? 1'b1 : 1'b0);

assign tmp_fu_118_p2 = numReps_dout << 32'd9;

assign tmp_i_fu_135_p2 = ((o_i_reg_87 == 32'd0) ? 1'b1 : 1'b0);

always @ (posedge ap_clk) begin
    tmp_reg_181[8:0] <= 9'b000000000;
end
