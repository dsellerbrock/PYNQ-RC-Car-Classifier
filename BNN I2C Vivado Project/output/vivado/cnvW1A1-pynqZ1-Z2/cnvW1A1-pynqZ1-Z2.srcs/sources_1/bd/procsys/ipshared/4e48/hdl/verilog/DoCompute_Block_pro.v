...
reg   [31:0] numReps_read_reg_45;
reg    ap_block_state1;
wire   [31:0] tmp_71_i_fu_40_p2;
reg   [31:0] tmp_71_i_reg_51;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((tmp_71_out_out_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if (((tmp_71_out_out_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign tmp_71_i_fu_40_p2 = (numReps_read_reg_45 + tmp_fu_35_p2);

assign tmp_71_out_out_din = tmp_71_i_reg_51;

assign tmp_fu_35_p2 = numReps_read_reg_45 << 32'd3;

endmodule //DoCompute_Block_pro
